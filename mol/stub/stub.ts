	...
	function $mol_stub_message( max_length : number ) {
 ...
 export {$mol_stub_strings,$mol_stub_code,$mol_stub_price,$mol_stub_product_name,$mol_stub_company_name_big,$mol_stub_company_name_small,$mol_stub_company_name,$mol_stub_person_name,$mol_stub_person_avatar,$mol_stub_city,$mol_stub_time,$mol_stub_message}