...
import  $r from 'mol_regexp'

	


	const { begin, end, latin_only, or, optional, repeat_greedy } = $r.$mol_regexp

	export let $mol_view_tree2_prop_signature = $r.$mol_regexp.from([
		begin,
	...
	export function $mol_view_tree2_to_js_old( this: $, descr: $mol_tree2 ) {
		...
		for( const klass of descr.kids ) {
			...
			const props = $.$mol_view_tree2_class_props( klass )
